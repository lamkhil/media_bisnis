...
<div class="copy">
  <div class="container">
    <div class="row copy-row">
      <p>Copyright @<script type="text/javascript">document.write(new Date().getFullYear());</script> <a href="{{ env('APP_URL') }}">{{ env('APP_NAME') }}</a>. All rights reserved</p>
    </div>
  </div>
</div>
...
<div class="copy">
  <div class="container">
    ...
    <div style='text-align:center;'>
        <a class='dmca-badge' href='//www.dmca.com/Protection/Status.aspx?ID=487158c1-5ce1-4f66-8767-db3914db2fb8' rel='nofollow noreferrer noopener' target='_blank'>
          <img alt='DMCA Protection' src='https://images.dmca.com/Badges/_dmca_premi_badge_4.png?ID=487158c1-5ce1-4f66-8767-db3914db2fb8' title='DMCA Protection'/>
      </a>
